...
import notesCollection from './models/notes';
import chatMessageCollection from './models/chatMessage';
import contentCollection from './models/content';
...
orm.registerModel(notesCollection)
orm.registerModel(chatMessageCollection)
orm.registerModel(contentCollection)
...
DB.initialize = () => {
  return new Promise((resolve, reject) => {
    orm.initialize(config, (err, models) => {
      ...
      DB.Notes = models.collections.tbl_note
      DB.ChatMessage = models.collections.tbl_chat_message
      DB.Content = models.collections.tbl_content
