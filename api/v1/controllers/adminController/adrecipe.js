  ...
  addRecipe: (req, res) => {
    async.waterfall([
      ...
      (fields, files, nextCall) => {
        if (fields && (!fields.title || !fields.foodCategory || !fields.prepTime || !fields.serves || !fields.directions || !fields.foodType || !fields.ingredients)) {
          return nextCall({
      ...
      async (fields, nextCall) => {
        let insertData = {
          ...
          recipeForSale: fields.recipeForSale,
          recipePrice: fields.recipePrice,
