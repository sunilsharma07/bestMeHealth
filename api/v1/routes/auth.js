...
const AdNotesController = require('../controllers/adminController/adnotes.js')
const AdExerciseController = require('../controllers/adminController/adexercise.js')
const AdTipController = require('../controllers/adminController/adtip.js')
const AdContentController = require('../controllers/adminController/adcontent.js')
const AdCookingVideoController = require('../controllers/adminController/adcookingvideo.js')
// Import Call Controller
const CallController = require('../controllers/callController/zoomCall.js')
...
// Call Controller
router.post('/admin/createCall', CallController.createCall)
...
router.post('/admin/addNewAdmin', AdUsersController.addNewAdmin)
router.post('/admin/getAdminDetails', AdUsersController.getAdminDetails)
router.post('/admin/changedAdminStatus', AdUsersController.changedAdminStatus)
router.post('/admin/getAllAdminListing', AdUsersController.getAllAdminListing)
...
router.post('/admin/getAllFeedbackListing', AdCommonController.getAllFeedbackListing)
...
router.post('/admin/getAllTestListing', AdTestController.getAllTestListing)
router.post('/admin/getFit132TestResult', AdTestController.getFit132ReportResult)
router.post('/admin/updateFit132TestResult', AdTestController.updateFit132ReportResult)
router.post('/admin/getMicronutrientsTestResult', AdTestController.getMicronutrientsReportResult)
router.post('/admin/updateMicronutrientsTestResult', AdTestController.updateMicronutrientsReportResult)
...
// Admin Noted API's
router.post('/admin/addUsersNotes', AdNotesController.addUsersNotes)
router.post('/admin/getNotes', AdNotesController.getNotes)
router.post('/admin/updateNotes', AdNotesController.updateNotes)
router.post('/admin/deleteNotes', AdNotesController.deleteNotes)

// Admin Exercise API's
router.get('/admin/getAllExerciseListing', AdExerciseController.getAllExerciseListing)
router.post('/admin/changedExerciseStatus', AdExerciseController.changedExerciseStatus)
router.post('/admin/viewExerciseDetails', AdExerciseController.viewExerciseDetails)

// Admin Tip API's
router.post('/admin/addNewTip', AdTipController.addNewTip)
router.post('/admin/getAllTipListing', AdTipController.getAllTipListing)
router.post('/admin/deleteTip', AdTipController.deleteTip)
router.post('/admin/viewTipDetails', AdTipController.viewTipDetails)
router.post('/admin/updateTip', AdTipController.updateTip)

// Admin Content API's
router.post('/admin/getAllContentListing', AdContentController.getAllContentListing)
router.post('/admin/getContentDetails', AdContentController.getContentDetails)
router.post('/admin/updateContent', AdContentController.updateContent)

// Admin Cooking Video API's
router.get('/admin/getCookingVideoListing', AdCookingVideoController.getCookingVideoListing)
router.post('/admin/addNewCookingVideo', AdCookingVideoController.addNewCookingVideo)
